...
-- VALUES
--   ('Ronald', 'Firbank', Doctor),
--   ('Virginia', 'Woolf', Legal),
--   ('Piers', 'Gaveston', DoP),
--   ('Charles', 'LeRoi', Director),
--   ('Katherine', 'Mansfield', manager),
--   ('Dora', 'Carrington', assistant),
--   ('Edward', 'Bellamy', janitor),
--   ('Montague', 'Summers', toilet scrubber),
--   ('Octavia', 'Butler', urinal cleaner),
--   ('Unica', 'Zurn', NULL, pigeon crap cleaner);
